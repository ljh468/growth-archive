...
VALUES
    ...
    (12, null, 'local-demo', 'reading/member-reading.jpg', '/images/member-reading.jpg', 'READING_RECORD', 'image/jpeg', 1200, 900, 260000, '2026-06-01 09:00:00+09'),
...
INSERT INTO invite_codes (id, code_hash, code_preview, is_active, created_by_member_id, created_at)
VALUES (1, '94ee059335e587e501cc4bf90613e0814f00a7b08bc7c648fd865a2af6a22cc2', '****', true, 1, now());
...
FROM (
    VALUES
        ...
        (3, 'stocks'), (3, 'economy'), (3, 'data'),
        (4, 'writing'), (4, 'mindfulness'), (4, 'relationships'),
        (5, 'real-estate'), (5, 'personal-finance'), (5, 'saving'),
        (6, 'running'), (6, 'reading'), (6, 'frugality'),
        (7, 'career'), (7, 'development'), (7, 'productivity'),
        (8, 'family'), (8, 'saving'), (8, 'pension'),
        (9, 'ai'), (9, 'writing'), (9, 'side-project'),
        (10, 'meditation'), (10, 'psychology'), (10, 'time-management')
...
VALUES
    ...
    (7, 'KAKAO', 'seed-book-007', '9780984358106', '부의 추월차선', '엠제이 드마코', '토트', '2013-08-20', 'https://covers.openlibrary.org/b/isbn/9780984358106-L.jpg', 'VERIFIED', '{}', now(), now()),
    (8, 'KAKAO', 'seed-book-008', '9781585424337', '생각하라 그리고 부자가 되어라', '나폴레온 힐', '국일미디어', '2015-10-20', 'https://covers.openlibrary.org/b/isbn/9781585424337-L.jpg', 'VERIFIED', '{}', now(), now()),
...
VALUES
    ...
    (39, 1, 'local-demo', 'reviews/2026-05-reading-01.jpg', '/images/member-reading.jpg', 'MEETING_REVIEW', 'image/jpeg', 1200, 900, 260000, '2026-05-10 13:10:00+09'),
...
VALUES
    (1, 'REGULAR_READING', '1월 독서기록 모임', '1월에 남긴 독서기록을 함께 읽고 다음 실행 문장을 고릅니다.', '2026-01-11 10:00:00+09', '서울 성수', '성수 북라운지 2층', 16, 0, 21, 1, 'HELD', '2026-01-01', true, '2026-01-01 00:10:00+09', now()),
    (2, 'REGULAR_ACTION', '1월 실행계획 모임', '월초에 정한 실행목표를 함께 이야기하고 편하게 수다 나누는 자리입니다.', '2026-01-25 10:00:00+09', '서울 성수', '성수 북라운지 2층', 16, 0, 22, 1, 'HELD', '2026-01-01', true, '2026-01-01 00:10:00+09', now()),
    ...
    (4, 'REGULAR_READING', '2월 독서기록 모임', '2월 독서기록에서 각자 실행한 문장을 나눕니다.', '2026-02-08 10:00:00+09', '서울 성수', '성수 북라운지 2층', 16, 0, 24, 1, 'HELD', '2026-02-01', true, '2026-02-01 00:10:00+09', now()),
    (5, 'REGULAR_ACTION', '2월 실행계획 모임', '월초에 적어둔 실행목표를 꺼내 놓고 서로의 한 달 이야기를 나눕니다.', '2026-02-22 10:00:00+09', '서울 성수', '성수 북라운지 2층', 16, 0, 25, 1, 'HELD', '2026-02-01', true, '2026-02-01 00:10:00+09', now()),
    ...
    (7, 'REGULAR_READING', '3월 독서기록 모임', '3월 독서기록을 바탕으로 투자와 습관의 기준을 정리합니다.', '2026-03-08 10:00:00+09', '서울 성수', '성수 북라운지 2층', 16, 0, 21, 1, 'HELD', '2026-03-01', true, '2026-03-01 00:10:00+09', now()),
    (8, 'REGULAR_ACTION', '3월 실행계획 모임', '각자 정한 실행목표가 한 달 동안 어떻게 흘러갔는지 편하게 나눕니다.', '2026-03-22 10:00:00+09', '서울 성수', '성수 북라운지 2층', 16, 0, 22, 1, 'HELD', '2026-03-01', true, '2026-03-01 00:10:00+09', now()),
    ...
    (10, 'REGULAR_READING', '4월 독서기록 모임', '4월 독서기록에서 관계와 일의 태도를 돌아봅니다.', '2026-04-12 10:00:00+09', '서울 성수', '성수 북라운지 2층', 16, 0, 24, 1, 'HELD', '2026-04-01', true, '2026-04-01 00:10:00+09', now()),
    (11, 'REGULAR_ACTION', '4월 실행계획 모임', '월초의 실행목표를 돌아보고 잘된 일과 막힌 일을 가볍게 이야기합니다.', '2026-04-26 10:00:00+09', '서울 성수', '성수 북라운지 2층', 16, 0, 25, 1, 'HELD', '2026-04-01', true, '2026-04-01 00:10:00+09', now()),
    ...
    (13, 'REGULAR_READING', '5월 독서기록 모임', '5월 독서기록을 함께 읽고 오래 남을 실행을 고릅니다.', '2026-05-10 10:00:00+09', '서울 성수', '성수 북라운지 2층', 16, 0, 21, 1, 'HELD', '2026-05-01', true, '2026-05-01 00:10:00+09', now()),
    (14, 'REGULAR_ACTION', '5월 실행계획 모임', '정해둔 실행목표를 소재로 서로의 일상과 실행 이야기를 나눕니다.', '2026-05-24 10:00:00+09', '서울 성수', '성수 북라운지 2층', 16, 0, 22, 1, 'HELD', '2026-05-01', true, '2026-05-01 00:10:00+09', now()),
    ...
    (16, 'REGULAR_READING', '6월 독서기록 모임', '6월 독서기록에서 바로 실행한 내용을 공유합니다.', '2026-06-14 10:00:00+09', '서울 성수', '성수 북라운지 2층', 16, 0, 24, 1, 'HELD', '2026-06-01', true, '2026-06-01 00:10:00+09', now()),
    (17, 'REGULAR_ACTION', '6월 실행계획 모임', '월초에 설정한 실행목표를 놓고 이야기 나누고 편하게 수다 떠는 자리입니다.', '2026-06-28 10:00:00+09', '서울 성수', '성수 북라운지 2층', 16, 0, 25, 1, 'SCHEDULED', '2026-06-01', true, '2026-06-01 00:10:00+09', now()),
...
VALUES
    (1, 1, 2, '새해 첫 독서기록을 함께 열어본 시간', '1월 독서기록 모임에서는 각자 새해에 붙잡고 싶은 문장을 나눴습니다. 혼자 읽을 때는 지나쳤던 부분이 다른 사람의 실행 사례를 들으며 더 선명해졌고, 저도 이번 달에는 책 한 권에서 한 가지 행동만 고르기로 했습니다.', 31, 'ACTIVE', '2026-01-11 13:30:00+09', now()),
