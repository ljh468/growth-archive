...
public class OnboardingController {
    ...
    public ApiResponse<InviteCodeResponse> verifyInviteCode(
        ...
        onboardingService.verifyInviteCode(request, body.code());
    ...
    public ApiResponse<TermsResponse> agreeTerms(
        ...
        onboardingService.agreeTerms(request, body.termsAgreed(), body.privacyAgreed());
    ...
    public ApiResponse<OnboardingResponse> completeProfile(
        ...
        onboardingService.completeProfile(request, body.toCommand());
